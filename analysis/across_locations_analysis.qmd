...
plot1 <- age_plot(
  ...
  plot_title = "Drawing Euclidean distance from Centroid by Age Across Locations and Categories",
...
plot2 <- age_plot(
  ...
  y_var = "distance",
  plot_title = "Drawing cosine dissimilarity from Centroid by Age Across Locations and Categories",
...
plot3 <- age_plot(
  ...
  y_var = "distance",
  plot_title = "Drawing dissimilarity from Centroid by Age Across Locations and Categories",
  plot_subtitle = "Participant means and age means with 95% CIs",
